...
## 补充：egf种多项式exp组合意义的代数证明

这里的多项式系数是根据二项式系数推广得到的，即
$$
\sum_{\sum_{i}^ka_i=n}\frac{n!}{k!\Pi_ia_i!}
$$
...
$$
**注意：**那么多个egf的乘积就是背包组合(显然，如果这是ogf，那么对应次没有多项式系数，那么元素就没有区别，即有重复；这也告诉egf和ogf有什么区别:有标号和无标号，而标号特质是由组合中多项式系数表征出来的)
